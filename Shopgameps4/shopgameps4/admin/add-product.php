...
<?php 
        ...
        if($_SERVER['REQUEST_METHOD']=='POST'){
            ...
            if($ten_san_pham !='' && $id_type != '' && $mo_ta != '' && $gia_san_pham != ''){
            //chèn dữ liệu vào
            $sql_1 = " INSERT INTO products ( name_product, type_product , description, price ,img_product) 
                                     VALUES ('$ten_san_pham', '$id_type', '$mo_ta', '$gia_san_pham','$target_file') ";
                ...
                <div class="block-fluid">
                    <form action="" method="POST" enctype="multipart/form-data">
                    	<div class="row-form">
                            ...
                            <div class="span9"><input type="text" name="ten_san_pham" placeholder="Nhập sản phẩm mới"/></div>
                            <div class="clear"></div>
                        </div> 
                        ...
                        <div class="row-form">
                                ...
                                <div class="span9"><input type="text" name="mo_ta" placeholder="Nhập mô tả"/></div>
                                <div class="clear"></div>
                        </div>

                        <div class="row-form">
                            <div class="span3">Giá sản phẩm:</div>
                            <div class="span9"><input type="text" name="gia_san_pham" placeholder="Nhập giá"/></div>
                            <div class="clear"></div>
                        </div>
