...
<body>
    <div id="content">
        ...
        <form method="post" action="">
            <div id="data">
                ...
                <input type="text" name="first_operand" autocomplete="off" value="<?php echo $first_Operand?>"/><br />
                ...
                <input type="text" name="second_operand" autocomplete="off" value="<?php echo $second_Operand?>"/><br />
            </div>
            <div id="buttons">
                <label>&nbsp;</label>
    ...
    <?php echo "<h1 style='text-align:center;'>Result:" . $ket_qua . "</h1>"; ?>
</body>
